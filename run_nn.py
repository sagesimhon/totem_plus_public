...
# TODO: Add visualization of training progress
...
metadata = {'input_mins': in_mins.tolist(), 'input_maxs': in_maxs.tolist(), 'output_mins': out_mins.tolist(),
            'output_maxs': out_maxs.tolist(), 'd': args.d,
            'w': args.w, 'input_ch': mlp_input_dim, 'output_ch': 2, 'is_embedded': args.use_embed_fn, 'n_epochs': args.num_epochs, 'n_freqs': args.n_freqs}
