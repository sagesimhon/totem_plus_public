...
def parse_detect_arguments():
    ...
    parser.add_argument('--x_axis', type=float, required=True, help='% nn used (to be saved in array for x axis of stats plotting)')
    parser.add_argument('--use_nn', type=bool_type, default=True, help='whether or not nn was used to interpolate for this unwarped data being analyzed (ie whether --use_nn was True in run_unwarping.py)')

    parser.add_argument('--grid_size', default=50, type=int)
    parser.add_argument('--patch_size', default=50, type=int)
    parser.add_argument('--protect_totem', type=bool_type, default=True)
